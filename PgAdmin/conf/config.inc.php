<?php
	...
	$conf['servers'][0]['host'] = 'ec2-54-225-66-44.compute-1.amazonaws.com';
	...
	$conf['servers'][0]['defaultdb'] = 'd92ocidl7ptsqs';

	// Specify the path to the database dump utilities for this server.
	// You can set these to '' if no dumper is available.
	$conf['servers'][0]['pg_dump_path'] = '/usr/lib/postgresql/9.6/bin/pg_dump';
	$conf['servers'][0]['pg_dumpall_path'] = '/usr/lib/postgresql/9.6/bin/pg_dumpall';
